...
/// Testing:
/// SSTables can correctly store multiple versions of the same key.
/// The SSTable builder properly writes these entries to disk.
/// The SSTable iterator can correctly iterate over the entries, respecting key ordering and timestamps.
